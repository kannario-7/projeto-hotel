...
function paraBanco(k, o, hotelId){
  ...
  switch(k){
    ...
    case "pg": b.reserva_id=o.reservaId||null; b.hospede_id=o.hospedeId||null; b.valor=o.valor; b.forma=o.forma; b.data=o.data; b.observacoes=o.observacoes; if(o.tipo!==undefined)b.tipo=o.tipo; if(o.criadoEm!==undefined)b.criado_em=o.criadoEm; if(o.usuarioId!==undefined)b.usuario_id=o.usuarioId||null; if(o.usuarioNome!==undefined)b.usuario_nome=o.usuarioNome||null; break;
...
function paraApp(k, b){
  ...
  switch(k){
    ...
    case "pg": o.reservaId=b.reserva_id; o.hospedeId=b.hospede_id; o.valor=b.valor; o.forma=b.forma; o.data=b.data; o.observacoes=b.observacoes; o.tipo=b.tipo; o.criadoEm=b.criado_em; o.usuarioId=b.usuario_id; o.usuarioNome=b.usuario_nome; break;
...
export async function carregarConfig(hotelId){
  ...
  return { hn:data.nome, hcnpj:data.cnpj, htel:data.telefone, hemail:data.email, tax:data.taxa_servico, hci:data.checkin_horario, hco:data.checkout_horario, pm:data.formas_pagamento||["dinheiro","cartao","debito","credito","pix"],
    ...
    slug:data.slug, reservasPublicas:data.reservas_publicas_ativas===true };
}
...
// Liga/desliga o motor de reservas publico do hotel (opt-in). Retorna {ok, error}.
export async function definirReservasPublicas(hotelId, ativo){
  var { error } = await supabase.from("hoteis").update({ reservas_publicas_ativas: ativo===true }).eq("id", hotelId);
