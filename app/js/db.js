...
function paraBanco(k, o, hotelId){
  ...
  switch(k){
    ...
    case "pg": b.reserva_id=o.reservaId||null; b.hospede_id=o.hospedeId||null; b.valor=o.valor; b.forma=o.forma; b.data=o.data; b.observacoes=o.observacoes; if(o.tipo!==undefined)b.tipo=o.tipo; break;
...
function paraApp(k, b){
  ...
  switch(k){
    ...
    case "pg": o.reservaId=b.reserva_id; o.hospedeId=b.hospede_id; o.valor=b.valor; o.forma=b.forma; o.data=b.data; o.observacoes=b.observacoes; o.tipo=b.tipo; break;
