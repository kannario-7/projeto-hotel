// Ponto de entrada da aplicação HospedaPrime
import * as utils from "./utils.js";
import { St, seed, ensureAdmin, restaurarDadosStore } from "./store.js";
...
// Boot: garante dados e admin, decide login
seed();ensureAdmin();
ui.initModalOverlay();
changelog.aplicarVersaoUI();

var user=auth.getCurrentUser();
if(!user){auth.showLogin()}else{auth.hideLogin()}
